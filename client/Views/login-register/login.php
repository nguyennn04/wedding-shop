    ...
    <div class="lll">
        <div class="container" id="container">
            <div class="form-container sign-up-container">
                <form action="/dressRental/index.php?url=register" method="post">
                    <h1>ĐĂNG KÝ</h1>
            ...
            <div class="form-container sign-in-container">
                <form action="/dressRental/index.php?url=login" method="post">
                    <h1>ĐĂNG NHẬP</h1>
                    <div class="social-container">
                    ...
                    <button type="submit" name="dangnhapbtn">Đăng nhập</button>
                    <a href="?url=/"><i class="fas fa-door-open"></i> Quay lại trang chủ</a>
                </form>
            </div>
